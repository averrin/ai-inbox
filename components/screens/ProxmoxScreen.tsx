...
import { View, Text, TouchableOpacity, Modal, TextInput, FlatList, KeyboardAvoidingView, Platform, ScrollView, Alert, RefreshControl } from 'react-native';
...
export default function ProxmoxScreen() {
    const { servers, addServer, setServerData } = useProxmoxStore();
                    ...
                    <Modal visible={showAddModal} animationType="slide" presentationStyle="pageSheet" onRequestClose={() => setShowAddModal(false)}>
                        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1, backgroundColor: Colors.surface }}>
                            <ScrollView contentContainerStyle={{ padding: 24 }}>
                                <Text style={{ fontSize: 24, fontWeight: 'bold', color: Colors.text.primary, marginBottom: 24 }}>Add Proxmox Server</Text>
                                ...
                                <View style={{ flexDirection: 'row', gap: 12 }}>
                                    <TouchableOpacity onPress={() => setShowAddModal(false)} style={{ flex: 1, padding: 16, alignItems: 'center', borderRadius: 8, backgroundColor: Colors.surfaceHighlight }}>
