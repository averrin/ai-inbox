            ...
            <View className="mb-2">
                <SettingsListItem color={cal.color}>
                    ...
                    <Switch
                        ...
                        thumbColor={isPersonal ? "#ffffff" : "#94a3b8"}
                    />
                </SettingsListItem>
    ...
    return (
        <View className="flex-1">
            <View className="bg-slate-800/50 p-4 rounded-2xl border border-slate-700 mb-6">
                <Text className="text-indigo-200 font-semibold mb-2">Personal Account</Text>
            ...
            <View className="mb-4">
                <Text className="text-indigo-200 font-semibold mb-2">Personal Calendars</Text>
